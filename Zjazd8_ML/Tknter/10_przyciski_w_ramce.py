...
root = tk.Tk()
root.geometry('500x600+1400+100')
...
btn2.grid(row=0, column=1, sticky=tk.W+tk.E, padx=10, pady=10)

btn3 = tk.Button(buttonframe, text='3', font=('Arial', 15))
btn3.grid(row=0, column=2, sticky=tk.W+tk.E, padx=10, pady=10)

btn4 = tk.Button(buttonframe, text='4', font=('Arial', 15))
btn4.grid(row=1, column=0, sticky=tk.W+tk.E, padx=10, pady=10)

btn5 = tk.Button(buttonframe, text='5', font=('Arial', 15))
btn5.grid(row=1, column=1, sticky=tk.W+tk.E, padx=10, pady=10)

btn6 = tk.Button(buttonframe, text='6', font=('Arial', 15))
btn6.grid(row=1, column=2, sticky=tk.W+tk.E, padx=10, pady=10)

nextbtn = tk.Button(root, text='Test')
nextbtn.place(x=200, y=300, height=100, width=100)
